...
namespace VideoGame {
	...
	private:
		...
		Bitmap^ bmpSolido = gcnew Bitmap("MATERIALES\\bmpSoli.png");
		Bitmap^ bmpDestruible = gcnew Bitmap("MATERIALES\\bmpDestruir.png");
		...
		Bitmap^ bmpCalavera = gcnew Bitmap("MATERIALES\\copita.png");

		Bitmap^ bmpEnemigo = gcnew Bitmap("MATERIALES\\fue.png"); 
	public:
		MyForm(void)
		{
			InitializeComponent();
...
#pragma endregion
	...
	private: System::Void timer1_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		oControladora->dibujar(buffer->Graphics, bmpSuelo, bmpSolido, bmpCaja, bmpExplosion, bmpDestruible, bmpJugador, bmpEnemigo,bmpCalavera);
		buffer->Render(g);
